...
write a function to 
return the maximum number of element in A after appending elements from B (in the exmaple above the result is 6), if there is no such case, return -1
